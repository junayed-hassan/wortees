    ...
    <>
      <div className="relative flex items-center pt-10 ">
        <div className="font-gilroy w-[550px] text-center mx-auto">
          <p className="mb-4 text-2xl">It’s not just at-shirt</p>
          <h1 className="font-bold text-7xl">It’s a Manifesto to be Worn!</h1>
          <p className="pt-5 pb-4 font-medium font-xl">
          ...
          <button className="uppercase bg-[#A81A18] py-4 px-7 rounded-xl text-white">
            Leggi di più
          </button>
        </div>
        ...
        <div className="absolute px-10 top-[64%]">
